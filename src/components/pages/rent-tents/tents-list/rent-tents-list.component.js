        ...
        <>
            ...
            <Row className='my-5 pb-5'>
                ...
                <Col sm='6' md='6' lg='6' xl='4' className='d-flex justify-content-center my-2'>
                    <Col className='rent-tents-list p-3 text-center'>
                        <Row className="row justify-content-center align-items-center">
                            <img src={require('../../../../assets/img/color-canvas.png')} draggable='false' alt=''></img>
                        </Row>
                        <p align='left' className='px-2'>
                            ร้านผ้าใบ หินกอง สระบุรี รับสั่งทำเต็นท์
                        </p>
                ...
                <Col sm='6' md='6' lg='6' xl='4' className='d-flex justify-content-center my-2'>
                    <Col className='rent-tents-list p-3 text-center'>
                        <Row className="row justify-content-center align-items-center">
                            <img src={require('../../../../assets/img/front-gabletent.png')} draggable='false' alt=''></img>
                        </Row>
                        <p align='left' className='px-2'>
                            ร้านผ้าใบ หินกอง สระบุรี รับสั่งทำเต็นท์
                        </p>
                ...
                <Col sm='6' md='6' lg='6' xl='4' className='d-flex justify-content-center my-2'>
                    <Col className='rent-tents-list p-3 text-center'>
                        <Row className="row justify-content-center align-items-center">
                            <img src={require('../../../../assets/img/nylon-rope.png')} className='my-auto' draggable='false' alt=''></img>
                        </Row>
                        <p align='left' className='px-2'>
                            ร้านผ้าใบ หินกอง สระบุรี รับสั่งทำเต็นท์
                        </p>
